...
public class ConsultaVendasForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRelatorio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/edu/ifnmg/sistemavendas/apresentacao/imagens/1468285814_Paste.png"))); // NOI18N
    ...
    private void btnRelatorioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRelatorioActionPerformed
        try {
            String arquivoRelatorio = System.getProperty("user.dir")
                    + "/relatorios/RelatorioVendas.jasper";

            Map<String, Object> parametros = new HashMap<>();
            parametros.put("data", "Não informada");
            parametros.put("nomeCliente", "Não informado");
            parametros.put("cpfCliente", "Não informado");
            parametros.put("formaPagamento", "Todas");

            JRBeanCollectionDataSource fonteDados
                    = new JRBeanCollectionDataSource(this.listaVendas);
            ...
            JasperViewer telaExibicao
                    = new JasperViewer(relatorioGerado, false);
            telaExibicao.setTitle("Relatorio de Vendas");
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "Erro inesperado! Informe erro ao administrador do sistema",
                    "Relatorio de Vendas",
                    JOptionPane.ERROR_MESSAGE
            );
        }
